...
function ProductDetail() {
  ...
  return (
    <SiteLayout>
      {/* HERO */}
      <section className="relative -mt-16 h-[88svh] min-h-[600px] w-full overflow-hidden bg-[color:var(--steel)]">
        <img
          src={product.hero}
          alt={product.name}
        ...
        <div className="relative z-10 container-x flex h-full flex-col justify-end pb-20 pt-32 text-white">
          <div className="grid lg:grid-cols-12 gap-10 items-end">
            ...
            >
              ...
              <p className="mt-6 max-w-2xl text-lg text-white/85">{product.shortDesc}</p>
              <div className="mt-10 flex flex-wrap items-center gap-3">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 rounded-md bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground shadow-glow hover:opacity-90 transition"
                >
                  구매·렌탈 문의 →
                </Link>
                {(() => {
                  ...
                  return (
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-md border border-white/30 bg-white/5 px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-md hover:bg-white/10 hover:border-primary/60 transition"
                    >
            ...
            <motion.aside
              ...
              className="lg:col-span-4 lg:justify-self-end w-full lg:max-w-sm rounded-xl border border-white/15 bg-black/55 p-6 backdrop-blur-md"
            >
      ...
      <section className="py-24">
        <div className="container-x grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-3">
            <p className="text-primary text-sm font-semibold tracking-widest uppercase">Overview</p>
      ...
      <section className="py-24 bg-[color:var(--surface)]">
        <div className="container-x">
          ...
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-balance max-w-2xl">
            기능과 강점
          </h2>
      ...
      <section className="py-24">
        <div className="container-x">
          <p className="text-primary text-sm font-semibold tracking-widest uppercase">Gallery</p>
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-balance">장비 갤러리</h2>
      ...
      <section className="py-24 bg-[color:var(--surface)]">
        <div className="container-x">
          <p className="text-primary text-sm font-semibold tracking-widest uppercase">Use Cases</p>
          <h2 className="mt-2 text-3xl md:text-4xl font-bold text-balance">활용 분야</h2>
          <div className="mt-10 grid sm:grid-cols-2 md:grid-cols-4 gap-4">
            {product.useCases.map((u, i) => (
              ...
              >
                <div className="font-mono text-xs text-primary">CASE 0{i + 1}</div>
                <div className="mt-2 font-bold text-lg">{u}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="container-x">
          <div className="rounded-2xl border border-border bg-card px-6 py-8 md:px-10 md:py-9 shadow-card flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
      ...
      <section className="py-24 bg-[color:var(--surface)]">
        <div className="container-x">
          <div className="flex items-end justify-between flex-wrap gap-4 mb-10">
            <div>
              <p className="text-primary text-sm font-semibold tracking-widest uppercase">Related</p>
              <h2 className="mt-2 text-3xl md:text-4xl font-bold">관련 제품</h2>
            </div>
